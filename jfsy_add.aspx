<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jfsy_add.aspx.cs" Inherits="EmptyProjectNet40_FineUI.admin.jfsy_add" %>
                ...
                <table id="tb1" runat="server" width="100%" style="height: 366px">
                    ...
                    <tr>
                        <td colspan="13" class="style16" style="text-align: center">
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="添加经费明细（可多次添加）" UseSubmitBehavior="false" />
