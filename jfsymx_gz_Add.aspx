<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jfsymx_gz_Add.aspx.cs" Inherits="EmptyProjectNet40_FineUI.admin.jfsymx_gz_Add" %>
                    ...
                    <Items>
                         ...
                         <f:Panel ID="Panel3" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server" >
                           ...
                           <f:Panel ID="Panel7" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server" >
                            <Items>
                                 <f:NumberBox ID="NumberBox_syje" runat="server" Label="使用金额(元)"  MinValue="0" DecimalPrecision="2" NoNegative="True" Required="true" ShowRedStar="True" ColumnWidth="50%" Margin="0 5 5 0" EmptyText="系统自动汇总" Readonly="true" Enabled="false"></f:NumberBox>
                                 </Items>
                        </f:Panel>
