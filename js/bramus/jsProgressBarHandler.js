			 ...
			 */
				_setBgPosition		: function(percentage) {
				    ...
				    if (percentage <= 100)
				        ...
				        $(this.id + "_percentImage").style.backgroundPosition = (this.initialPos + (100 * this.pxPerPercent)) + "px 50%";
					...
					// adjust the background image and backIndex
						...
						if (percentage > 100) {
						    $(this.id + "_percentImage").style.backgroundImage = "url( images/bramus/percentImage_back4.png)";
						}
						else if (percentage>0&&percentage < 40) {
						    $(this.id + "_percentImage").style.backgroundImage = "url( images/bramus/percentImage_back1.png)";
						}
						else if (percentage >= 40 && percentage<80) {
						    $(this.id + "_percentImage").style.backgroundImage = "url( images/bramus/percentImage_back2.png)";
						}
						else if (percentage >= 80 && percentage <=100) {
						    $(this.id + "_percentImage").style.backgroundImage = "url( images/bramus/percentImage_back3.png)";
						}
