<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jfsymx_xm_up.aspx.cs" Inherits="EmptyProjectNet40_FineUI.admin.jfsymx_xm_up" %>
                    ...
                    <Items>
                         <f:Panel ID="Panel2" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server" >
                            <Items>
                               ...
                               <f:DropDownList ID="DropDownList_jfzl" runat="server" Label="经费种类" Margin="0 5 0 0"  ColumnWidth="50%" OnSelectedIndexChanged="DropDownList_jfzl_SelectedIndexChanged" AutoPostBack="true" Enabled="false">
