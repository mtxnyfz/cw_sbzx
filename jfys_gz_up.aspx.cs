...
{
    public partial class jfys_gz_up : System.Web.UI.Page
    {
        ...
        protected void DataBind(int ID)
        {
            ...
            if (sdr.Read())
            {
                ...
                DropDownList_sj_databind(sdr["EJMC"].ToString().Trim());
                dp_setvalue(DropDownList_sj, sdr["SJMC"].ToString().Trim());
        ...
        protected void Button_save_Click(object sender, EventArgs e)
        {
            ...
            //JFYSSBB_model.JFZL = TextBox_jfzl.Text.Trim();
            ...
            if (DropDownList_sj.SelectedText.Trim() == "请选择")
            {
                ...
                return;
                    ...
                    try
                    {
                        JFYSSBB_model.YJMC =DropDownList_yj.SelectedValue.Trim();
                        JFYSSBB_model.EJMC = DropDownList_ej.SelectedValue.Trim();
                        JFYSSBB_model.SJMC = DropDownList_sj.SelectedValue.Trim();
