<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jfys_xm_add.aspx.cs" Inherits="EmptyProjectNet40_FineUI.admin.jfys_xm_add" %>
                    ...
                    <Items>
                         ...
                         <f:Panel ID="Panel10" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server" >
                            <Items>
                                ...
                                <f:TextBox ID="TextBox_fzr" Label="项目负责人" Margin="0 5 0 0" Required="true" ShowRedStar="true" ColumnWidth="34%" runat="server" Enabled="false">
                                </f:TextBox>
