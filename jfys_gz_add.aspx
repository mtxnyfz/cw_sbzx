<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jfys_gz_add.aspx.cs" Inherits="EmptyProjectNet40_FineUI.admin.jfys_gz_add" %>
         ...
         <f:Panel ID="Panel5" runat="server" BodyPadding="5px"
            ...
            <Items>
                    ...
                    <Items>
                         <f:Panel ID="Panel2" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server" >
                            <Items>
                               ...
                               <f:DropDownList ID="DropDownList_jfzl" runat="server" Label="经费种类" Margin="0 5 0 0"  ColumnWidth="80%" AutoPostBack="true" OnSelectedIndexChanged="DropDownList_jfzl_SelectedIndexChanged">
                         ...
                         <f:Panel ID="Panel4" Layout="Column" CssClass="formitem" ShowHeader="false" ShowBorder="false" runat="server" >
                            <Items>
                                  <f:NumberBox ID="NumberBox_flf" runat="server" Label="福利费(元)"  MinValue="0" DecimalPrecision="2" NoNegative="True" Required="true" ShowRedStar="True" ColumnWidth="25%" Margin="2 5 0 0"  OnTextChanged="NumberBox_zz_TextChanged" AutoPostBack="true"></f:NumberBox>
                                  <f:NumberBox ID="NumberBox_sbhc" runat="server" Label="设备耗材费(元)"  MinValue="0" DecimalPrecision="2" NoNegative="True" Required="true" ShowRedStar="True" ColumnWidth="25%" Margin="2 5 0 0"  OnTextChanged="NumberBox_zz_TextChanged" AutoPostBack="true"></f:NumberBox>
                                  <f:NumberBox ID="NumberBox_ywf" runat="server" Label="业务费(元)"  MinValue="0" DecimalPrecision="2" NoNegative="True" Required="true" ShowRedStar="True" ColumnWidth="25%" Margin="2 2 0 0"  OnTextChanged="NumberBox_zz_TextChanged" AutoPostBack="true"></f:NumberBox>
                                 <f:NumberBox ID="NumberBox_qt" runat="server" Label="其他(元)"  MinValue="0" DecimalPrecision="2" NoNegative="True" Required="true" ShowRedStar="True" ColumnWidth="25%" Margin="2 2 0 0"  OnTextChanged="NumberBox_zz_TextChanged" AutoPostBack="true"></f:NumberBox>
                ...
                <f:Toolbar ID="Toolbar1" runat="server" ToolbarAlign="Right" Position="Bottom">
                    <Items>
                        <f:Button ID="Button1" Text="添加到预算列表" ValidateForms="Form4" ValidateMessageBox="true" runat="server" OnClick="Button_add_Click"   Margin="10 5 10 0">
                        </f:Button>
                         ...
                         <f:Panel ID="Panel22"   CssClass="formitem"  runat="server"  Title="已添加的工作经费预算列表"  ShowBorder="false" ShowHeader="true" AutoScroll="true"   Layout="Fit"  Width="830px" Height="300px">
                                       <Items>
 ...
 <Toolbars>
                     ...
                     <Columns>
                       <f:RowNumberField EnablePagingNumber="true" ID="c1" HeaderText="序号" Width="50px" />
                        <f:BoundField Width="100px" DataField="YJMC"  HeaderText="一级"  ID="c2" />
                      
                        <f:BoundField Width="150px" DataField="EJMC" HeaderText="二级"    ID="c3"/>
                    
                         
                        <f:BoundField Width="150px" DataField="SJMC" HeaderText="三级"   ID="c4"/>
                    ...
                    <Columns>
                          ...
                          <f:BoundField Width="100px" DataField="SBHCF" HeaderText="设备耗材费" ID="BoundField2" DataFormatString="{0:N2}"/>
                          <f:BoundField Width="100px" DataField="YWF" HeaderText="业务费" ID="BoundField3" DataFormatString="{0:N2}"/>
                          <f:BoundField Width="100px" DataField="QT" HeaderText="其他" ID="BoundField4" DataFormatString="{0:N2}"/>
                          <f:BoundField Width="100px" DataField="YSJE" HeaderText="预算金额(小计)" ID="BoundField5" DataFormatString="{0:N2}"/>
